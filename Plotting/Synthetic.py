...
methods = [
    ("TuRBO",               "Turbo_{D}D_{l}_regret.pt"),
    ("D-scaled TuRBO",      "Turbo_lognormal_{D}D_{l}_regret.pt"),
    ("AdaScale-TuRBO",      "Turbo_lognormal_new_{D}D_{l}_regret.pt"),
    ("D-scaled LogEI",      "{D}D_{l}_Vanilla_regret.pt"),
    ("Linear BO",              "{D}D_{l}_linear_BO_regret.pt"),
    # ("CMA-ES",              "CMAES_{D}D_{l}_regret.pt"),
]
...
plt.savefig("Synthetic.png", bbox_inches="tight")
# plt.show()
