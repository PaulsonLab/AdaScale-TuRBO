...
# per-row horizons
T_by_D = {60: 501, 100: 1001}

methods = [
    ("TuRBO",               "Turbo_Rover_regret.pt"),
    ("D-scaled TuRBO",      "Turbo_lognormal_Rover_regret.pt"),
    ("AdaScale-TuRBO",      "Turbo_lognormal_new_Rover_regret.pt"),
    ("D-scaled LogEI",      "Rover_Vanilla_regret.pt"),
    ("Linear BO",              "Rover_linear_BO_regret.pt"),
]

base_dir = "/fs/ess/PAS2983/jontwt/Lengthscale_init/Rover/Results"
...
for i, D in enumerate(Ds):
    ...
    for j, ell in enumerate(ls):
        ...
        ax.set_title(rf"$D={D}$, {ell}", fontsize=fontsize)
...
plt.savefig("Rover_violin_GP.png", bbox_inches="tight")
# plt.show()
