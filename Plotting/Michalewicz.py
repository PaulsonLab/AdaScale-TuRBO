...
turbo_original = -(torch.load('/fs/ess/PAS2983/jontwt/Lengthscale_init/Michalewicz/Results/Turbo_50D_Michalewicz_regret.pt')[0:replicate,0:1000])
turbo_lognormal = -(torch.load('/fs/ess/PAS2983/jontwt/Lengthscale_init/Michalewicz/Results/Turbo_lognormal_50D_Michalewicz_regret.pt')[0:replicate,0:1000])
turbo_lognormal_new = -(torch.load('/fs/ess/PAS2983/jontwt/Lengthscale_init/Michalewicz/Results/Turbo_lognormal_new_50D_Michalewicz_regret.pt')[0:replicate,0:1000])
vanilla = torch.load('/fs/ess/PAS2983/jontwt/Lengthscale_init/Michalewicz/Results/50D_Michalewicz_Vanilla_regret.pt')[0:replicate,0:1000]
linear = torch.load('/fs/ess/PAS2983/jontwt/Lengthscale_init/Michalewicz/Results/50D_Michalewicz_linear_BO_regret.pt')[0:replicate,0:1000]
...
plt.title('50D Michalewicz', fontsize = fontsize)
plt.savefig('50D Michalewicz.png')